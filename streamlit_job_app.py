...
st.markdown("""I think I understand the needs for ecosystem development reasonably well and I am confident have the diverse skill set needed to deal with a wide variety of developers, issues, and user tasks.""")
